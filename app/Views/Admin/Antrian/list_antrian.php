...
<div class="row pb-10">
        ...
        <div class="card-box height-100-p widget-style3">
            <div class="d-flex flex-wrap">
                <div class="widget-data">
                    <div class="weight-700 font-24 text-dark" id="total_antrian"></div>
    ...
    <div class="col-xl-3 col-lg-3 col-md-6 mb-20">
        <div class="card-box height-100-p widget-style3">
            <div class="d-flex flex-wrap">
                <div class="widget-data">
                    <div class="weight-700 font-24 text-dark" id="antrian_sekarang"></div>
                    <div class="font-14 text-secondary weight-500">
                        Antrian saat ini
                    </div>
                </div>
    ...
    <div class="col-xl-3 col-lg-3 col-md-6 mb-20">
        <div class="card-box height-100-p widget-style3">
            <div class="d-flex flex-wrap">
                <div class="widget-data">
                    <div class="weight-700 font-24 text-dark" id="antrian_saya"></div>
                    <div class="font-14 text-secondary weight-500">
                        Antrian loket saya
                    </div>
                </div>
    ...
    <div class="col-xl-3 col-lg-3 col-md-6 mb-20">
        <div class="card-box height-100-p widget-style3">
            <div class="d-flex flex-wrap">
                <div class="widget-data">
                    <div class="weight-700 font-24 text-dark" id="siswa_antrian"></div>
                    <div class="font-14 text-secondary weight-500">Sisa Antrian</div>
                </div>
                <div class="widget-icon">
