...
class masterReferensiModel extends Model
{
    ...
    {
        if ($id == false) {
            return $this->select('master_referensi.id_referensi, master_referensi.nama_referensi, master_referensi.kode_referensi, master_referensi.status_referensi, master_referensi.urutan, master_kategori.nama_kategori')
